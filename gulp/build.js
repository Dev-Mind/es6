...
//gulp-traceur treats all files as modules. This allows use of the export, module and import syntax. In this way the transformer
// can be used to compile ES6
...
module.exports = function(gulp, config) {
  ...
  gulp.task('build', ['clean', 'ddescriber', 'jshint', 'dist:css', 'dist:vendors', 'dist:js', 'dist:font', 'dist:images', 'dist:favicon', 'dist:index', 'test']);
   ...
   */
  gulp.task('bundle:testjs', function() {
  ...
  gulp.task('bundle:js', ['bundle:testjs'], function() {
    return gulp.src(paths.build.test + '/js')
      .pipe(concat('app.js'))
